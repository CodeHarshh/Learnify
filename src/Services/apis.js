...
export const courseEndpoints = {
  ...
  COURSE_DETAILS_API: BASE_URL + "/course/details",
...
export const bestPickCourses = {
  bestPickCourses_API: BASE_URL + "/course/bestPickCourses",
  moreRecommendedCourses_API: BASE_URL + "/course/moreRecommendedCourses",
}
