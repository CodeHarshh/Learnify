...
import { courseEndpoints,review } from "../apis"
...
const{CREATE_REVIEW_API}=review;
...
export const addCourseDetails = async (formData, token) => {
  ...
  try {
    ...
    console.log("CREATE COURSE API ERROR jiiii ............", error)
    toast.error(error.message)
  }
  toast.dismiss(toastId)
  return result
...
export const fetchInstructorCourses = async (token,id) => {
  // console.log("id------->",id);
  // console.log("------->",token);
  let result = []
  const toastId = toast.loading("Loading...")
