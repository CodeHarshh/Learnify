...
const RenderSteps = () => {
  // Ensure step has a default value in case Redux state is undefined
  const step = useSelector((state) => state.course?.step) || 1;
  console.log("Redux State:", useSelector((state) => state)); // Check the entire state
console.log("Step:", step); //
  ...
  console.log("Current step:", stepp); // Debug step value
  ...
  return (
    <>
      ...
      {step === 1 && <CourseInformationForm setStepp={setStepp} />}
