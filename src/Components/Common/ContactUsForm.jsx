...
const submitContactForm = async (data) => {
  try {
    const response = await fetch('https://formspree.io/f/mkgbddqv', {
      method: 'POST',
      headers: {
    ...
    <form className='flex flex-col gap-7' onSubmit={handleSubmit(submitContactForm)}>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-5'>
                    {/* dropdown */}
                    <div className='flex w-[91px] flex-col gap-2'>
                        <select
                                name='dropdown'
                                id="dropdown"
      ...
      MozAppearance: 'textfield', // For Firefox
           ...
           <button
  type="submit"
  className="rounded-md bg-gradient-to-r from-[#4a00e0] to-[#8e2de2] px-6 py-3 text-center text-[13px] font-bold text-white shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] 
